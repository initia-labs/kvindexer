...
func (sm EvmNFTSubmodule) getCollectionMinter(ctx context.Context, colAddr sdk.AccAddress) (*types.Minter, error) {
...
func (sm EvmNFTSubmodule) getCollectionFromVMStore(ctx context.Context, colAddr sdk.AccAddress) (*types.CollectionResource, error) {
...
func (sm EvmNFTSubmodule) getIndexedCollectionFromVMStore(ctx context.Context, colAddr sdk.AccAddress) (*nfttypes.IndexedCollection, error) {
...
func (sm EvmNFTSubmodule) getNftResourceFromVMStore(ctx context.Context, collectionAddr sdk.AccAddress, tokenId string) (*types.NftResource, error) {
...
func (sm EvmNFTSubmodule) getIndexedNftFromVMStore(ctx context.Context, contractAddr sdk.AccAddress, tokenId string, ownerAddr *sdk.AccAddress) (*nfttypes.IndexedToken, error) {
...
// evm only uses bech32 address, not hex
